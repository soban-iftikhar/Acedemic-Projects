...
def preprocess(df: pd.DataFrame) -> tuple[pd.DataFrame, dict]:
    ...
    # ── 2h. Select final feature columns ──
    feature_cols = [
...
def save_best_model(trained: dict, results_df: pd.DataFrame, meta: dict):
    ...
    # Save metadata for prediction system
    meta_to_save = {
